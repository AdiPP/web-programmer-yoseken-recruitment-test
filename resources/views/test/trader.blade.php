...
<html lang="en">
  <head>
    ...
    <title>Basic Table Design - Bracket Responsive Bootstrap 4 Admin Template</title>

    <!-- vendor css -->
    <link href="{{url('/')}}/bracket/lib/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="{{url('/')}}/bracket/lib/Ionicons/css/ionicons.css" rel="stylesheet">
    <link href="{{url('/')}}/bracket/lib/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
    <link href="{{url('/')}}/bracket/lib/jquery-switchbutton/jquery.switchButton.css" rel="stylesheet">
    <link href="{{url('/')}}/bracket/lib/highlightjs/github.css" rel="stylesheet">

    <!-- Bracket CSS -->
    <link rel="stylesheet" href="{{url('/')}}/bracket/css/bracket.css">
  </head>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Basic Table</h4>
